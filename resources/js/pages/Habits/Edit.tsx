...
export default function EditHabit({ habit, categories }: Props) {
    const { t } = useLanguage()
    ...
    return (
        <AppLayout>
            <Head title={t.habits.editHabit} />
            <PageHeader title={t.habits.editHabit} description="">
                ...
                <Card className="mx-auto max-w-2xl">
                    <CardContent className="p-6">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {/* Active */}
                            <div className="flex items-center justify-between">
                                <Label htmlFor="active">{t.habits.title} Active</Label>
                                <Switch
                                    id="active"
